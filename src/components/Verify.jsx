...
const Verify = () => {
  return (
    <div>
      ...
      <div className="font-semibold text-black-600 text-lg font-serif p-4">dribble</div>
       ...
       <div className="text-gray-400 text-sm font-seif font-bold py-5 px-2">Hire Designers</div>
        ...
        <div className="relative py-2">
          <FiSearch className = "text-gray-400  absolute top-3 left-100 ml-3 mt-4"/>
        ...
        <div className="py-4 px-8 sm:flex-row">
        <img src="logo192.jpg" alt="logo" className="w-8 h-8 object-cover rounded-full sm:w-16 sm:h-16"/>
        </div>
       <button className="px-2 bg-pink-500 text-white font-semibold rounded-md m-3 font-serif text-sm sm:py-3">Upload</button>
      </div>
      ...
      If you still dont see it, you can resend the <p1 className="text-pink-400 sm:px-3">conformation email.</p1>
      </div>
      ...
      <div className="bg-gray-100">
        ...
        <div className="text-pink-400 font-semibold text-xl font-serif px-8 py-8 sm:px-4">dribble</div>
        <div className=" font-serif font-bold py-9 md:px-16 text-xs">For Designers</div>
        <div className=" font-serif font-bold py-9  md:px-16  sm:px-4 text-xs">Hire designers</div>
        <div className=" font-serif font-bold py-9 md:px-16 text-xs sm:px-4">Company</div>
        <div className=" font-serif font-bold py-9 md:px-14 text-xs sm:px-4">Directories</div>
        <div className=" font-serif font-bold py-9 px-16 text-xs">Company Resources</div>
        </div>
       <div className="font-serif  text-xs  py-2 md:px-6 flex flex-row sm:px-2">
       ...
       Dribble is the world<br/> leading community <br/>for creatives to share,<br/>grow,and get hired.
        ...
        <div className="md:px-12 sm:px-4 flex flex-col">
         <div>Go Pro!</div>
        ...
        <div className="flex flex-row">
        <div className="text-xs text-gray-500 font-bold font-ariel py-4 md:px-12 sm:px-6 ">
          @ 2023 dribble all rights reserved</div>
        <div className="md:px-80 sm:px-20"></div>
