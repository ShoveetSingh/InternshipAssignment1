...
const Profile = () => {
  ...
  return (
      <div className="flex flex-col">
        ...
        <h2 className="font-serif py-4 justify-center items-center px-96 text-2xl font-semibold">Welcome! Let's create your profile</h2>
        <p className="font-sans px-96 text-gray-400 text-sm font-bold">Let others get to know you better!</p>
        <p className="font-serif py-6 px-96 text-lg font-semibold">Add an Avatar</p>
        ...
        <div className = " flex-col px-96 py-8">
